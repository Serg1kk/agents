...
2. Адаптируй под ответ: пропиши выбранный скилл в промптах роль-агентов — ИЛИ предложи описать логику работы с агентами в `CLAUDE.md` / `AGENTS.md` проекта (спроси, какой вариант удобнее)
3. Если скилла нет — замени обязательный вызов скилла на «выясни требования диалогом до планирования»
...
3. `researcher` — обязательно дай поисковый MCP из имеющихся: context7 / Exa / Brave Search / аналог; если поисковых MCP нет — он работает на встроенных WebSearch/WebFetch
